# I am no literary artist, and this is my first visual novel ever written, but I tried my best.
# Will be modeled after the Japanese visual novels I have played.
# May seem very repetitive - but the repetition, like a chorus in a song, is supposed to add to the immersion.
# Later: add option to skip info scenes/class scenes
# At the end: aura will merge with MC, the creative aura, the spirit of creativity - MC will be able to complete final project?
